...
const messages: Record<AppLocale, Record<string, MessageValue>> = {
  'zh-CN': {
    ...
    'login.mode': '模式',
    'login.modeReturning': '已有账号',
    'login.modeFirst': '首个账号',
    'login.route': '接口',
    'login.tabLogin': '登录',
    ...
    'login.bootstrapAdmin': '默认管理员账号：admin / admin',
  ...
  en: {
    ...
    'login.mode': 'Mode',
    'login.modeReturning': 'Returning user',
    'login.modeFirst': 'First account',
    'login.route': 'Route',
    ...
    'login.bootstrapAdmin': 'Default bootstrap admin: admin / admin',
    ...
    'index.teamOnly': 'Team only',
    'index.publicRead': 'Public read',
...
export function useAppLocale() {
  ...
  function visibilityLabel(visibility: 'public' | 'team' | null | undefined) {
